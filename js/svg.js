(function() {
	...
	function animateFloor() {
		floor.animate({'x2': '198'}, 400, mina.easeinout, animateBuildings);
	}

	function animateBuildings() {
		buildingBase1.animate({'height': '70'}, 800, mina.elastic);
		setTimeout(function(){
			buildingBase2.animate({'height': '46'}, 800, mina.elastic);
		}, 100);
		setTimeout(function(){
			buildingBase3.animate({'height': '123'}, 800, mina.elastic, function(){
				animateRoofs();
				animateDoors();
			});
		}, 200);
	...
	function animateRoofs() {
		buildingRoof1.animate({'width': '81'}, 300, mina.easeinout);
		setTimeout(function(){
			buildingRoof2.animate({'width': '70'}, 300, mina.easeinout);
		}, 100);
	}

	function animateDoors() {
		buildingDoor1.animate({'height': '27'}, 300, mina.easeinout);
		setTimeout(function(){
			buildingDoor2.animate({'height': '22'}, 300, mina.easeinout, function(){
				animateWindows();
			});
		}, 100);
	}
